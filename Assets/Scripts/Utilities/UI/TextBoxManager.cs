...
public class TextBoxManager : MonoBehaviour
{
    ...
    public static List<string> MessageOptionsList = new List<string>
            { 
    ...
    void Start()
    {
        ...
        else
        {
            ...
            int randomIndex = Random.Range(0, MessageOptionsList.Count);
            string randomMessage = MessageOptionsList[randomIndex];
